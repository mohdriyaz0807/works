...
var hit1 = function () {
    var players1 = ['Shane Watson', 'Faf du Plessis', 'Ambati Rayudu', 'Sam Curran', 'MS Dhoni', 'Dwayne Bravo', 'Ravindra Jadeja', 'N Jagadeesan', 'Karn Sharma', 'Shardul Thakur'];
    var final = 0;
    var max = [];
    var highScore = [];
    ...
    var maxScore = max;
    var index = highScore.indexOf(max);
    (document.getElementById("player")).innerHTML = players1["" + index];
...
var hit2 = function () {
    var players2 = ['Rohit Sharma', ' Hardik Pandya', ' Jasprit Bumrah', ' Krunal Pandya', ' Ishan Kishan', ' Surya Kumar Yadav', ' Rahul Chahar', ' Anmolpreet Singh', ' Jayant Yadav', ' Quinton de Kock', ' Kieron Pollard'];
    var final = 0;
    var max = [];
    var highScore = [];
    ...
    var maxScore = max;
    var index = highScore.indexOf(max);
    (document.getElementById("player1")).innerHTML = players2["" + index];
